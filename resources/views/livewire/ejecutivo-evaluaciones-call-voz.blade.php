        ...
        @foreach($evaluaciones as $evaluacion)
            ...
            <tr id="fila_{{ $evaluacion->id }}" class="hover:bg-gray-50">
                ...
                <td class="px-3 py-1 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    @else
                        <a class="text-xs inline-flex items-center py-1.5 px-2 mx-0.5 my-0.5 transition-colors duration-150 text-white bg-green-600 border border-green-700 hover:bg-green-700 hover:text-white rounded focus:shadow-outline " href="{{ route($evaluacion->getPauta()->id == 2 ? 'evaluacions.indexBrigido' : 'evaluacions.index', ['evaluacionid'=>$evaluacion->id])}}" disabled>
                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
