...
class EscalasSeeder extends Seeder
{
    ...
    private $escalas = [
        ...
        ['id' => 9, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 4, 'name' => 'Cambio de Plan o Condiciones comerciales'],
        ['id' => 10, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 5, 'name' => 'Campaña o Cross-selling'],
        ['id' => 11, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 6, 'name' => 'Canales de Atención'],
        ['id' => 12, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 7, 'name' => 'Carga Manual'],
        ['id' => 13, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 8, 'name' => 'Condiciones Comerciales de Planes, Servicios y Equipo'],
        ['id' => 14, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 9, 'name' => 'Contingencia de Servicios'],
        ['id' => 15, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 10, 'name' => 'Comunicación o Redes'],
        ['id' => 16, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 11, 'name' => 'Estado de Deuda o Reposición'],
        ['id' => 17, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 12, 'name' => 'Explicación de Boleta o Tráfico'],
        ['id' => 18, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 13, 'name' => 'Facturación o Solicitudes Asociadas'],
        ['id' => 19, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 14, 'name' => 'Funciones o Configuración de Equipo'],
        ['id' => 20, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 15, 'name' => 'Medios de Pago o Recarga'],
        ['id' => 21, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 16, 'name' => 'Objeción de Cobros'],
        ['id' => 22, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 17, 'name' => 'Renuncia o Retención'],
        ['id' => 23, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 18, 'name' => 'Roaming o LDI'],
        ['id' => 24, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 19, 'name' => 'Saldo o Cargo en ORGA'],
        ['id' => 25, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 20, 'name' => 'Seguimiento de Negocios'],
        ['id' => 26, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 21, 'name' => 'Seguros y Asistencias'],
        ['id' => 27, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 22, 'name' => 'Servicio Técnico de Equipos'],
        ['id' => 28, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 23, 'name' => 'Venta de Productos y Servicios'],
        ['id' => 29, 'grupo_id' => 1, 'descripcion' => 'Motivo', 'value' => 24, 'name' => 'Otras Consultas o Requerimientos'],
